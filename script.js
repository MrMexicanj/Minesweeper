...
function applyCustomGame () {
  try {
    ...
    if (customGridWidth < 5) {
      document.getElementById("modal-msg").innerHTML = "Ingresa un ancho mas grande.";
      return;
    }
    if (customGridHeight < 5) {
      document.getElementById("modal-msg").innerHTML = "Ingresa una altura mas grande.";
      return;
    }
